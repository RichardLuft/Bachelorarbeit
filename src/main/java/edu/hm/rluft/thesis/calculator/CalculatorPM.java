...
public class CalculatorPM extends AbstractPM {
	...
	@Operation
	public void plus() {
		changeOperation(MathematicalOperation.Addition);
	}

	@Operation
	public void minus() {
		changeOperation(MathematicalOperation.Subtraction);
	}

	@Operation
	public void multiply() {
		changeOperation(MathematicalOperation.Multiplication);
	}

	@Operation
	public void divide() {
		changeOperation(MathematicalOperation.Division);
	}

	private void changeOperation(MathematicalOperation operation) {
